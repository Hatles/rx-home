 ...
 */
export function async_set_domains_to_be_loaded(hass: core.HomeAssistant, domains: Set[str]): None {
 ...
 */
export function setup_component(hass: core.HomeAssistant, domain: str, config: ConfigType): bool {
...
export async function _async_setup_component(
     ...
     * Log helper.
     */
    log_error(msg: str, link: Optional[str] = None): None {
...
export function async_when_setup(
     ...
     * Call the callback.
     */
    async loaded_event(event: core.Event): None {

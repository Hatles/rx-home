...
export const SINGLE_ENTITY_SCHEMA = vol.Any(
    true,
    vol.Schema(
        {
...
export const ENTITY_VALUES_SCHEMA = vol.Any(true, vol.Schema({str: SINGLE_ENTITY_SCHEMA}))

export const ENTITY_POLICY_SCHEMA = vol.Any(
    true,
    vol.Schema(
        {

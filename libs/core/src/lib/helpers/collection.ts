        ...
        *,
            ...
            websocket_api.async_register_command(
               ...
               `${this.api_prefix}/list`,
                ...
                websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend(
                    {vol.Required("type"):`${this.api_prefix}/list`}
                ),
            )
        }
            ...
            websocket_api.async_register_command(
               ...
               `${this.api_prefix}/create`,
                ...
                websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend(
                    {
                        **this.create_schema,
                        vol.Required("type"):`${this.api_prefix}/create`,
                    }
                ),
            )
        }
        ...
        websocket_api.async_register_command(
           ...
           `${this.api_prefix}/update`,
            ...
            websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend(
                {
                    **this.update_schema,
                    vol.Required("type"):`${this.api_prefix}/update`,
                    vol.Required(this.item_id_key): string,
                }
            ),
        )
        ...
        websocket_api.async_register_command(
           ...
           `${this.api_prefix}/delete`,
            ...
            websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend(
                {
                    vol.Required("type"):`${this.api_prefix}/delete`,
                    vol.Required(this.item_id_key): string,
                }
            ),
        )

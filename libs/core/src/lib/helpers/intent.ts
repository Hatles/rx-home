...
export const SLOT_SCHEMA = vol.Schema({}, extra=vol.ALLOW_EXTRA)
...
export class IntentHandler {
    ...
    slot_schema: Optional<vol.Schema> = null
    _slot_schema: Optional<vol.Schema> = null

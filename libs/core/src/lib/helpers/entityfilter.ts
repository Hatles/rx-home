...
export const BASE_FILTER_SCHEMA = vol.Schema(
    {
...
export const FILTER_SCHEMA = vol.All(BASE_FILTER_SCHEMA, convert_filter)
...
export const INCLUDE_EXCLUDE_FILTER_SCHEMA_INNER = vol.Schema(
    {
...
export const INCLUDE_EXCLUDE_BASE_FILTER_SCHEMA = vol.Schema(
    {
        vol.Optional(
...
export const INCLUDE_EXCLUDE_FILTER_SCHEMA = vol.All(

...
export const USER_SCHEMA = Joi.Schema(
    {
        Joi.Required("username"): string,
        Joi.Required("password"): string,
        Joi.Optional("name"): string,
    }
)


export const CONFIG_SCHEMA = AUTH_PROVIDER_SCHEMA.extend(
    {Joi.Required("users"): [USER_SCHEMA]}, extra=Joi.PREVENT_EXTRA
)

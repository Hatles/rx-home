...
export const CONFIG_SCHEMA = MULTI_FACTOR_AUTH_MODULE_SCHEMA.extend({}, extra=Joi.PREVENT_EXTRA)
...
export class TotpAuthModule extends MultiFactorAuthModule {
    ...
    async async_validate(user_id: string, user_input: Dict<any>): boolean {
        ...
        // set INPUT_FIELD_CODE as Joi.Required is not user friendly
...
export class TotpSetupFlow extends SetupFlow {
     ...
     */
    constructor(
        auth_module: TotpAuthModule, setup_schema: Joi.Schema, user: User
    ) {
